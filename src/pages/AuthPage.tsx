...
import { z } from 'zod';
import { Eye, EyeOff, Mail, Lock, User, Loader2, Sparkles, Bot, ArrowRight, Globe, ArrowLeft } from 'lucide-react';
  ...
  <div className="relative h-full w-full overflow-hidden">
    ...
    <div className="relative z-10 h-full flex flex-col items-center justify-center p-12 text-white">
      ...
      >
        {/* Logo */}
        <motion.div 
          className="w-24 h-24 rounded-3xl bg-white/10 backdrop-blur-xl flex items-center justify-center mx-auto mb-6 border border-white/20"
        ...
        <h2 className="text-3xl font-bold mb-2 font-cyber tracking-wider">Welcome Back</h2>
        <p className="text-xs font-mono text-white/60 tracking-widest mb-6">THE REAL WORKFORCE AI</p>
  ...
  <div className="relative h-full w-full overflow-hidden">
    ...
    <div className="relative z-10 h-full flex flex-col items-center justify-center p-12 text-white">
      ...
      >
        ...
        <h2 className="text-3xl font-bold mb-2 font-cyber tracking-wider">Start Building</h2>
        <p className="text-xs font-mono text-white/60 tracking-widest mb-6">THE REAL WORKFORCE AI</p>
        <p className="text-lg text-white/80 max-w-sm mb-8">
        ...
        <div className="space-y-3 text-left max-w-xs mx-auto">
          {[
            ...
            <motion.div
              ...
              className="flex items-center gap-3 p-3 rounded-xl bg-white/10 backdrop-blur border border-white/10"
            >
