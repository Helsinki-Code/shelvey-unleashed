...
import { TRADING_AGENTS, AGENT_CATEGORIES, type TradingAgent } from '@/lib/trading-agents';
...
export const AgentTeamGrid = ({ agentStatuses = {} }: AgentTeamGridProps) => {
  const [selectedAgent, setSelectedAgent] = useState<TradingAgent | null>(null);
  const [filterCategory, setFilterCategory] = useState<string | null>(null);

  const agents = Object.values(TRADING_AGENTS);
