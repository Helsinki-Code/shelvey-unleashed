  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "border-glow": {
          "0%, 100%": { borderColor: "hsl(var(--cyber-green) / 0.3)" },
          "50%": { borderColor: "hsl(var(--cyber-green) / 0.8)" },
        },
        "data-flow": {
        ...
        "float-particle": {
          ...
          "50%": { transform: "translate(-5px, -40px) scale(0.9)", opacity: "0.7" },
          "75%": { transform: "translate(-15px, -20px) scale(1.05)", opacity: "0.9" },
        },
      },
      animation: {
